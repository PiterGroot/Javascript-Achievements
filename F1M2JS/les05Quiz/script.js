...
function finishQuiz() {
  ...
  if(playerData.goodAnswers == 3){
    resultBox.innerHTML =   "<p>Jouw resultaat <br>goede antwoorden " + playerData.goodAnswers + "<br>foute antwoorden " + playerData.wrongAnswers + "</p>" + "<h>Gefeliciteerd! U heeft alle antwoorden goed.</h>"
  }
  if(playerData.goodAnswers == 2){
    resultBox.innerHTML = "<p>Jouw resultaat <br>goede antwoorden " + playerData.goodAnswers + "<br>foute antwoorden " + playerData.wrongAnswers + "</p>" + "<h>Bijna! U had bijna de perfecte score.</h>"
  }
  if(playerData.goodAnswers == 1){
    resultBox.innerHTML = "<p>Jouw resultaat <br>goede antwoorden " + playerData.goodAnswers + "<br>foute antwoorden " + playerData.wrongAnswers + "</p>" + "<h>Jammer! U had 1 antwoord goed.</h>"
  }
  if(playerData.goodAnswers == 0){
    resultBox.innerHTML = "<p>Jouw resultaat <br>goede antwoorden " + playerData.goodAnswers + "<br>foute antwoorden " + playerData.wrongAnswers + "</p>" + "<h>Balen! U had geen antwoord goed. Volgende keer beter.</h>"
  }
}
